...
CREATE TABLE `select_master` (
  ...
  `select_key` varchar(45) DEFAULT NULL,
...
INSERT INTO `select_master` VALUES (1,'state','statekey'),(2,'city','city'),(3,'relationship','relationship'),(4,'course','course'),(5,'technology','technology'),(6,'department','department'),(7,'pref_location','pref_location'),(8,'language','language');
